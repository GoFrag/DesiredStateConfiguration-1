...
Domain_Controllers -ConfigurationData $ConfigData -OutputPath "C:\Users\dyeo\OneDrive - Imperial College London\DesiredStateConfiguration\Testing\Active_Directory_Domain_Services\Config" -Verbose

#$creds = $null
#$creds = Get-Credential
#Start-DscConfiguration -path "C:\Users\dyeo\OneDrive - Imperial College London\DesiredStateConfiguration\Testing\Active_Directory_Domain_Services\Config" -wait -verbose -credential $Creds -force